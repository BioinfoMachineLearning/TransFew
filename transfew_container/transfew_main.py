...
def main():
    ...
    parser.add_argument('--output', type=str, default="predictions.tsv.gz", help="File to save output")
    ...
    print(f"\n>>>>>>>> ✅Step I: Finished extracting feature embeddings from the pretrained models! Results are saved in: {args.working_dir}/esm2_t48/.\n")
...
if __name__ == "__main__":
    main()
# python transfew_main.py --fasta-path /workspace/sequence.fasta --working-dir ./result            